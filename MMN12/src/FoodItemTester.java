...
public class FoodItemTester
{
			...
			throws NoSuchFieldException, SecurityException, IllegalArgumentException, IllegalAccessException
	{
		...
		printTestData("getProductionDate aliasing", "carrot.getProductionDate() == d6", carrot.getProductionDate() == d6, false);
		...
		System.out.println(carrotToString);
		...
		results();
		exportLog("FoodItem_Tester_Results_49Q14srBqj");

		System.out.println("Finished :)");
		System.out.println(
				"Check your desktop, you should see a new text file named \"FoodItem_Tester_Results_49Q14srBqj\"");
	...
	public static void exportLog(String fileName)
	{
		try
		{
			String fileLocation = String.format("%s/Desktop/%s.txt", System.getProperty("user.home"), fileName);
